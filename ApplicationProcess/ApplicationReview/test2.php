      ...
      $order = "DESC";
        ...
        { 
          ...
          ?>
                          ...
                          <div class="form-group col">
                            <label for="diploma_date" id="cityOfResidenceField">Year Diploma was Obtained</label>
...
<div class="card-body">
                            ...
                            <div class="form-group">
                              <textarea class="form-control" id="essay_answer" name="essay_answer" rows="10" placeholder="Essay" word-limit="true" max-words='501' min-words='299' disabled><?php echo $row['essay_answer']; ?></textarea>
                            </div>
                            <br>
                            <br>
                              <h4>Files</h4>
                              <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button type="button" class="btn-brown btn <?php echo $iddisable?>" <?php echo $iddisable?>onclick="id()" >Scan of your birth certificate or identity document</button>
...
window.open("https://ilimi.org/applications/uploads/<?php echo $nationalexamname ?>", "_blank");
}
function examgrade() {
window.open("https://ilimi.org/applications/uploads/<?php echo $examgradename ?>", "_blank");
}
function transcripts() {
window.open("https://ilimi.org/applications/uploads/<?php echo $transcriptsname ?>", "_blank");
}
function id() {
window.open("https://ilimi.org/applications/uploads/<?php echo $idname ?>", "_blank");
}
function letter() {
window.open("https://ilimi.org/applications/uploads/<?php echo $lettername ?>", "_blank");
}
function scholarship() {
window.open("https://ilimi.org/applications/uploads/<?php echo $scholarshipname ?>", "_blank");
}
      </script>
  </body>