          ...
          ?>
                        ...
                        <div class="form-group">
                          ...
                          <h4 class="card-title" id="essayHeader">Essay</h4>
                            <div class="form-group">
                              <textarea class="form-control" id="essay_answer" name="essay_answer" rows="10" placeholder="Paste you answer here*" word-limit="true" max-words='501' min-words='299' disabled><?php echo $row['essay_answer']; ?></textarea>
                            </div>
                            <div class="form-group">
...
<div class="card-body">
	<h4>Files</h4>
                              <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn-brown btn">High School National Exit Exam</button>
                                <button type="button" class="btn-brown btn">High School Final Exam Grade</button>
                                <button type="button" class="btn-brown btn">Transcripts from your last year of High School</button>
                                <button type="button" class="btn-brown btn">Scan of your birth certificate or identity document</button>
                                <button type="button" class="btn-brown btn">Letter of Recommandation</button>
                                <button type="button" class="btn-brown btn">Scholarship Form</button>
                              </div>
                              <br>
                            <br>
  <h3>Reviews</h3>
