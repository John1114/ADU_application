...
while ($counter <= count($files1)) {
  ?>
  <a href="https://ilimi.org/applications/uploads/<?php echo $files1[$counter]; ?>"> <?php echo $counter . ". " . $files1[$counter]; ?></a>
  <br>
<?php
     $counter += 1;
 }
...
?>
    ...
    <script>
function back() {
        location.href = "http://ilimi.org/applications/ApplicationReview/applicants.php";
      }
    </script>
  </div>
  </div>
